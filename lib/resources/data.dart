...
class Data
{
  ...
  final _levelsInfo = [
    ...
    {'levelNumber': 19, 'ans': 6, 'solved': false},
    // World 3
    ...
    {'levelNumber': 27, 'ans': 4, 'solved': false},
    ...
    {'levelNumber': 33, 'ans': 24, 'solved': false},
    {'levelNumber': 34, 'ans': 8, 'solved': false},
    {'levelNumber': 35, 'ans': 3, 'solved': false},
    {'levelNumber': 36, 'ans': 15, 'solved': false},
    {'levelNumber': 37, 'ans': 99, 'solved': false},
    {'levelNumber': 38, 'ans': 3, 'solved': false},
    {'levelNumber': 39, 'ans': 20, 'solved': false},
    // World 5
    {'levelNumber': 40, 'ans': 610, 'solved': false},
    {'levelNumber': 41, 'ans': 7, 'solved': false},
    {'levelNumber': 42, 'ans': 2, 'solved': false},
    {'levelNumber': 43, 'ans': 1001, 'solved': false},
    {'levelNumber': 44, 'ans': 4812, 'solved': false},
    {'levelNumber': 45, 'ans': 7534, 'solved': false},
    {'levelNumber': 46, 'ans': 15, 'solved': false},
    {'levelNumber': 47, 'ans': 126, 'solved': false},
    {'levelNumber': 48, 'ans': 112588, 'solved': false},
    {'levelNumber': 49, 'ans': 4, 'solved': false},
  ];
